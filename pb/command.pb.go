...
type ProductUpParam struct {
	...
	Price      string `protobuf:"bytes,3,opt,name=price,proto3" json:"price,omitempty"`           // 単価
...
func (x *ProductUpParam) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
...
type CategoryUpResult struct {
	...
	Category  *Category              `protobuf:"bytes,1,opt,name=category,proto3" json:"category,omitempty"`   // 商品カテゴリ
